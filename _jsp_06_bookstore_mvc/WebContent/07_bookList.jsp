...
<html lang="ko">
	...
	<body>
		...
		<button onclick="window.location.href='/_jsp_06_bookstore_mvc/mg/bookRegister.do'"> 
			책 등록
		</button>
			...
			<table border="1">
				...
				<c:forEach var="book" items="${ bookList }">
					<tr>
						...
						<td width="50">
							<button onclick="window.location.href='/_jsp_06_bookstore_mvc/mg/bookUpdate.do?book_id=${ book.book_id}&book_kind=${ book.book_kind}'">
								수정
							</button>
						</td>
						<td width="50">
							<button onclick="window.location.href='/_jsp_06_bookstore_mvc/mg/bookDeletePro.do?book_id=${ book.book_id}&book_kind=${ book.book_kind}'">
								삭제
							</button>
						</td>
					</tr>

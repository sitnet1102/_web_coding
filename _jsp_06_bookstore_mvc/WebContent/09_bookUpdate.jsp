...
<html lang="ko">
	...
	<body>
		...
		<c:if test="${ empty sessionScope.mngId }">
			<meta http-equiv="Refresh" content="0;url=/_jsp_06_bookstore_mvc/mg/main.do" >		
		</c:if>
		...
		<form method="post" action="/_jsp_06_bookstore_mvc/mg/bookUpdatePro.do" enctype="multipart/form-data">
			<table border="1">
				<tr>
					<th>분류선택</th>
					<td>

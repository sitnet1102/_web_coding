		...
		<table border="1">
			<tr>
				<td colspan="3" align="center">
					<a href="/list.do?book_kind=100">문학</a>&nbsp;&nbsp;&nbsp;
					<a href="/list.do?book_kind=200">외국어</a>&nbsp;&nbsp;&nbsp;
					<a href="/list.do?book_kind=300">컴퓨터</a>&nbsp;&nbsp;&nbsp;
					<a href="/list.do?book_kind=all">전체</a>
				</td>
			</tr>
			<c:forEach var="bookList" items="${ bookLists }">
				...
				<tr>
					<td colspan="3" align="center">
						<p><b>[ ${ book_kindName } ] 분류의 신간목록 : 
							<a href="/list.do?book_kind=${book_kind}">더보기</a></b>
						</p>
					</td>
				</tr>
				...
				<tr height="30">
					<td rowspan="4" width="100">
						<a href="/ookContent.do?book_id=${ book.book_id }&book_kind=${ book.book_kind }">
							<img src="/_jsp_06_bookstore_mvc/images/${ book.book_image }" width="100">
						</a>
					</td>
					<td width="350">
						<a href="/bookContent.do?book_id=${ book.book_id }&book_kind=${ book.book_kind }">
							${ book.book_title }
						</a>
					</td>
					<td rowspan="4" width="100">

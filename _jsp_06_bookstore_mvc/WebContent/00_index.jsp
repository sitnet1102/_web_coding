...
<body>
	    ...
	    <img class="noborder" id="logo" src="/_jsp_06_bookstore_mvc/images/logo.png"/>
...
# server.xml 파일에 커넥션 풀 설정
		...
		<Resource auth="Container"
			...
			url="jdbc:mysql://localhost:3306/_jsp_06_bookstore_mvc?serverTimezone=UTC"
			username="root" />
...
-------------------------------------------------------
# 데이터베이스 생성하기 
CREATE DATABASE _jsp_06_bookstore_mvc

# 데이터베이스 사용하기
USE _jsp_06_bookstore_mvc;
-------------------------------------------------------
# manager 테이블 생성하기

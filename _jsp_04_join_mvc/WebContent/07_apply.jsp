		...
		<div align="center">
			...
			<form action="applyPro.do" method="post">
				<h4>개인 정보</h4>
						...
						<label >이름</label>
						<input type="text" id="name" name="name" value="${ bean.name }" autofocus placeholder="공백없이 입력하세요">
						<br>
						<label >연락처</label>
				...
				<h4>지원 분야</h4>
						...
						<label>
							<input type="radio" name="field" value="publishing">웹 퍼블리싱
						</label>
					
						<label>
							<input type="radio" name="field" value="frontend">프론트앤드
						</label>
					
						<label>
							<input type="radio" name="field" value="application">웹 애플리케이션 개발
						</label>
